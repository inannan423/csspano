<style>
  ...
  body {
    ...
    overflow-x: hidden;
    border-bottom: #FFC300 solid 7px;
    margin-bottom: -20px;
    margin-right: -10px;
  }
  ...
  .el-menu {
    border-right: 0.1px solid #fcd44f5d;
  }

  .el-menu-item:focus,
  .el-menu-item:hover {
    outline: 0;
    background-color: #fbecba4f;
  }
          ...
          <el-scrollbar style="position:fixed;left: -10px; height:100%;width:230px">
            <el-menu default-active="1" unique-opened="true" class="el-menu-vertical-demo" style=" min-height: 700px;">
              ...
              <el-submenu index="2" style="color: black;">
                ...
                <router-link class="a" to="/jiguang">
                  <el-menu-item index="2-1"> 星空-古镇 </el-menu-item>
                </router-link>
                <router-link class="a" to="/lasa">
                  <el-menu-item index="2-2"> 拉萨-三亚-盐城 </el-menu-item>
                </router-link>
                <router-link class="a" to="/haitan">
                  <el-menu-item index="2-3"> 三亚海滨屋 </el-menu-item>
                </router-link>
                <router-link class="a" to="/riluo">
                  <el-menu-item index="2-4"> 日落房屋 </el-menu-item>
                </router-link>
...
<!-- <link href="https://cdn.bootcdn.net/ajax/libs/codemirror/5.65.3/codemirror.min.css" rel="stylesheet"> -->
...
export default {
  ...
  methods: {
    to() {
      ...
      window.location.href = "https://cn.bing.com/search?q=" + searchValue;
    },
  },
  watch: {
    //实现切换路由回到顶部
...
<style>
  ...
  ::-webkit-scrollbar-thumb {
    ...
    background: rgba(7, 68, 71, 0.1);
  }

  ::-webkit-scrollbar-track {
    -webkit-box-shadow: inset 0 0 5px rgba(0, 0, 0, 0.2);
    border-radius: 0;
    background: rgba(159, 241, 245, 0.1);
  }
</style>